<template>
  ...
  <p v-if="item.gear_category"><strong class="font-semibold">Gear category:</strong> {{ item.gear_category.name }}</p>
  <p v-if="item.vehicle_category"><strong class="font-semibold">Vehicle category:</strong> {{ item.vehicle_category }}
  </p>
  <p>
